...
void DFS(std::unordered_map <std::string, std::vector <std::string>>& Graph, std::unordered_map <std::string, bool> nodeInPath, std::string source, std::string destination, int currentTravel, int* result);
...
int main(){
  ...
  std::unordered_map <std::string, bool> nodeInPath;
